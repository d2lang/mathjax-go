...
// limitsSelection retains the parser entry point while sharing the exact
// scalar conversion with the renderer's source coreMO selection.
func limitsSelection(value any, exists bool) float64 {
	return mml.MactionSelectionNumber(value, exists)
}
