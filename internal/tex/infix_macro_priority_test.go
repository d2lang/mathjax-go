...
func TestInfixMacroPriorityPinnedReferences(t *testing.T) {
	...
	if fixture.MathjaxGitCommit != "ad8f5c21cb810236551da8c6512ba733e67357ee" || len(fixture.Cases) != 82 || limits.Baseline != "b8b28469b0c6357a93048864537bbbc61c56be56" || len(limits.Boundaries) != 30 {
	...
	expectedBoundaries := map[string]string{
		...
		"spaced-infix-alias-inline":       "unchanged separate parser boundary",
		"spaced-infix-alias-display":      "unchanged separate parser boundary",
		...
		"repeated-choose-inline":          "unchanged separate parser boundary",
		"repeated-choose-display":         "unchanged separate parser boundary",
		"repeated-over-inline":            "unchanged separate parser boundary",
		"repeated-over-display":           "unchanged separate parser boundary",
