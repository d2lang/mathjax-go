...
if (!base)
  throw Error(
    "usage: node generate_accent_script_xarrow.cjs /path/to/pinned/d2latex [evidence-directory]"
  );
...
const inputs = [["x-arrow-option", "\\xrightarrow[below]{above}", false], ["x-arrow-option", "\\xrightarrow[below]{above}", true]];
