...
The reference baseline is 5836be2e73642e7ee36e6e514ab724c2e687362a (D051/D055, D057, D058 and D052 included). The final candidate also inherits accepted D059 merge 75fd483b027e3c24eea5c4aa0e30b8beca7b8a1d. Of 50 public cases, 46 now match the raw primary SVG, full projected tree and dimensions; 40 of those differed from the parent. Two unchanged subsequent-script cases remain the tracked D053 Double exponent error (413×18 versus primary 20×25). Two unchanged stackrel controls have transparent TeXAtom grouping differences; all literal path data, root geometry, paint styles and exact Decimal-composed transforms match primary, with no fitted geometry or tolerance. Those four cases are isolated in stack_placement_boundaries.json with exact parent SVG and projected tree, original primary hash, source/mode and dimensions. They are not counted as raw primary matches and are not accepted through a generic normalization rule.
