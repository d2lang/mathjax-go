...
const records = [];
for (const request of JSON.parse(fs.readFileSync(path.join(__dirname, 'unbraced_prime_inputs.json')))) {
...
fs.writeFileSync(path.join(evidence,'unbraced_prime_mathjax_3_2_2.json'),JSON.stringify({
